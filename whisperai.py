...
# Example usage:
input_folder = "/Users/rahul.v/Documents/Rubixe/audio_s/"  # Replace with the folder containing your videos
output_folder = "audio_s"  # Replace with the folder where you want to save the transcriptions
